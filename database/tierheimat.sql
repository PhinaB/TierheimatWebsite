...
INSERT INTO VermisstGefundenTiere (ZuletztGeaendertNutzerID, TierartID, Typ, Datum, Ort, Beschreibung, Kontaktaufnahme, Bildadresse, Geloescht, ZuletztGeaendert) VALUES
    (1, 1, 'vermisst', '2024-01-02 00:00:000', 'Weimar', 'Wir waren am Samstag Abend mit Pablo in Weimar am Park an der Ilm spazieren und haben ihn nur kurz aus den Augen gelassen. Wir vermissen ihn sehr. Jeder Hinweis könnte uns bei der Suche helfen.', 'telefon', '../public/img/hund.jpg', 0, '2024-01-02 00:00:000'),
    (2, 3, 'vermisst', '2024-03-02 00:00:000', 'Vieselbach', 'Unser Degu Luke wird seit dem 2. März in Vieselbach vermisst. Hinweise nehmen wir dankend telefonisch entgegen. Bitte helfen Sie uns, ihn wiederzufinden!', 'telefon', '../public/img/katze.jpg', 0, '2024-01-02 00:00:000'),
    (2, 2, 'vermisst', '2024-01-03 00:00:000', 'Stotternheim', 'Lotta, unsere getigerte Katze mit einem weißen Fleck auf der Brust, wird seit dem 3. Januar in Stotternheim vermisst. Sie ist scheu, aber sehr lieb. Bitte melden Sie sich per E-Mail, falls Sie sie sehen.', 'email', '../public/img/katze2.jpg', 0, '2024-01-04 00:00:000'),
    (2, 3, 'vermisst', '2024-06-07 00:00:000', 'Erfurt', 'Unsere Schildkröte Raspun ist am 7. Juni in Erfurt verschwunden. Jeder Hinweis hilft uns, sie wiederzufinden. Bitte melden Sie sich per E-Mail!', 'email', '../public/img/schildkröte.jpg', 0, '2024-12-06 00:00:000'),
    (1, 2, 'vermisst', '2024-05-02 00:00:000', 'Arnstadt', 'Drako, unser schwarz-weißer Kater, wird seit dem 2. Mai in Arnstadt vermisst. Er trägt ein grünes Halsband mit unserer Telefonnummer. Bitte melden Sie sich per E-Mail, falls Sie ihn gesehen haben.', 'email', '../public/img/katzeVermisstGefunden.jpg', 0, '2024-11-04 00:00:000'),
    (2, 2, 'gefunden', '2024-05-23 00:00:000', 'Weimar', 'Ich habe die Katze am Mittwoch Abend in Erfurt an der Altonaer Straße gefunden. Sie wirkte verschreckt, abgemagert und hatte Flöhe. Ich habe sie mit nach Hause genommen und sie wieder aufgepäppelt. Jetzt geht es ihr wieder besser.', 'telefon', '../public/img/katze2.jpg', 0, '2024-01-05 00:00:000'),
    (2, 1, 'gefunden', '2023-09-27 00:00:000', 'Erfurt', 'Dieser Hund ist mir am 27. September in Erfurt zugelaufen. Falls Sie ihn vermissen, melden Sie sich bitte per E-Mail, damit er wieder nach Hause kann', 'email', '../public/img/hund2.jpeg', 0, '2024-06-04 00:00:000'),
    (1, 2, 'gefunden', '2024-02-25 00:00:000', 'Vieselbach', 'Ich habe diese Katze am 25. Februar in Vieselbach gefunden. Sie scheint ein Zuhause zu suchen. Bitte melden Sie sich telefonisch, falls Sie sie kennen.', 'telefon', '../public/img/katzeVermisstGefunden.jpg', 0, '2024-02-04 00:00:000'),
    (1, 1, 'gefunden', '2024-04-26 00:00:000', 'Erfurt', 'Dieser Hund ist mir am 26. April in Erfurt begegnet. Er war allein unterwegs. Falls Sie ihn suchen, melden Sie sich bitte per E-Mail!', 'email', '../public/img/hund.jpg', 0, '2024-03-04 00:00:000'),
    (2, 2, 'gefunden', '2024-06-19 00:00:000', 'Hohenfelden', 'Ich habe diesen Kater am 19. Juni in Hohenfelden gefunden. Er ist zutraulich und gut gepflegt. Bitte melden Sie sich telefonisch, falls er Ihnen gehört.', 'telefon', '../public/img/katzeGefunden.jpg', 0, '2024-01-07 00:00:000');

INSERT INTO BilderTiere (TierID, Bildadresse, Hauptbild, Alternativtext) VALUES
    (6, 'hund.jpg', TRUE, 'Bella'),
    (6, 'hund2.jpeg', FALSE, ''),
    (3, 'greta.jpg', TRUE, 'Greta, eine aktive Ratte'),
    (3, 'greta2.jpg', FALSE, ''),
    (15, 'greta2.jpg', TRUE, 'Kira, eine schmusige Ratte'),
    (15, 'greta.jpg', FALSE, ''),
    (2, 'natter2.jpeg', TRUE, 'eine tolle Tigerpython'),
    (2, 'natter.jpg', FALSE, ''),
    (4, 'papagei.jpg', TRUE, 'eine Gruppe Wellensittiche'),
    (4, 'papagei2.jpeg', FALSE, ''),
    (5, 'katze.jpg', TRUE, 'Katze'),
    (5, 'katze2.jpg', FALSE, ''),
    (7, 'hund.jpg', TRUE, 'Hund Rex'),
    (7, 'hund2.jpeg', FALSE, ''),
    (8, 'hund.jpg', TRUE, 'Hund Mila'),
    (8, 'hund2.jpeg', FALSE, ''),
    (1, 'hund.jpg', TRUE, 'Lila'),
    (1, 'hund2.jpeg', FALSE, ''),
    (16, 'hund2.jpeg', TRUE, 'Lilly'),
    (16, 'hund.jpg', FALSE, ''),
    (9, 'hase.jpeg', TRUE, 'Hase Fluffy'),
    (9, 'hase2.jpg', FALSE, ''),
    (10, 'hase2.jpg', TRUE, 'Hase Hoppel'),
    (10, 'hase.jpeg', FALSE, ''),
    (11, 'natter.jpg', TRUE, 'Kornnatter Korni'),
    (11, 'natter2.jpeg', FALSE, ''),
    (12, 'papagei.jpg', TRUE, 'Jendayasittich Lora'),
    (12, 'papagei2.jpeg', FALSE, ''),
    (13, 'papagei.jpg', TRUE, 'Rosella'),
    (13, 'papagei2.jpeg', FALSE, ''),
    (14, 'natter2.jpeg', TRUE, 'Kornnatter Monster'),
    (14, 'natter.jpg', FALSE, '');
