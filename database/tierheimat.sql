...
INSERT INTO VermisstGefundenTiere (ZuletztGeaendertNutzerID, TierartID, Typ, Datum, Ort, Beschreibung, Kontaktaufnahme, Bildadresse, Geloescht, ZuletztGeaendert) VALUES
    ...
    (2, 3, 'vermisst', '2024-06-07 00:00:000', 'Erfurt', 'Unsere Schildkröte Raspun ist am 7. Juni in Erfurt verschwunden. Jeder Hinweis hilft uns, sie wiederzufinden. Bitte melden Sie sich per E-Mail!', 'email', '../public/img/papagei.jpg', 0, '2024-12-06 00:00:000'),
    (1, 2, 'vermisst', '2024-05-02 00:00:000', 'Arnstadt', 'Drako, unser schwarz-weißer Kater, wird seit dem 2. Mai in Arnstadt vermisst. Er trägt ein grünes Halsband mit unserer Telefonnummer. Bitte melden Sie sich per E-Mail, falls Sie ihn gesehen haben.', 'email', '../public/img/katze.jpg', 0, '2024-11-04 00:00:000'),
    ...
    (1, 2, 'gefunden', '2024-02-25 00:00:000', 'Vieselbach', 'Ich habe diese Katze am 25. Februar in Vieselbach gefunden. Sie scheint ein Zuhause zu suchen. Bitte melden Sie sich telefonisch, falls Sie sie kennen.', 'telefon', '../public/img/katze2.jpg', 0, '2024-02-04 00:00:000'),
    ...
    (2, 2, 'gefunden', '2024-06-19 00:00:000', 'Hohenfelden', 'Ich habe diesen Kater am 19. Juni in Hohenfelden gefunden. Er ist zutraulich und gut gepflegt. Bitte melden Sie sich telefonisch, falls er Ihnen gehört.', 'telefon', '../public/img/katze.jpg', 0, '2024-01-07 00:00:000');
...
INSERT INTO BilderTiere (TierID, Bildadresse, Hauptbild, Alternativtext) VALUES
    ...
    (15, 'greta.jpg', FALSE, ''),
    (2, 'natter2.jpg', TRUE, 'eine tolle Tigerpython'),
    (2, 'natter.jpg', FALSE, ''),
    (4, 'papagei.jpeg', TRUE, 'eine Gruppe Wellensittiche'),
    (4, 'papagei2.jpg', FALSE, ''),
    ...
    (11, 'natter2.jpg', FALSE, ''),
    (12, 'papagei.jpeg', TRUE, 'Jendayasittich Lora'),
    (12, 'papagei2.jpg', FALSE, ''),
    (13, 'papagei.jpeg', TRUE, 'Rosella'),
    (13, 'papagei2.jpg', FALSE, ''),
    (14, 'natter2.jpg', TRUE, 'Kornnatter Monster'),
    (14, 'natter.jpg', FALSE, '');
