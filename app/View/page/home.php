...
<p class="fehlermeldung errorGeneral"></p>
...
<div id="page" class="hidden">
    <div class="tile">
        ...
        <div class="box-container box-container-button">
            <div>
                ...
                <a href="aktuellesWeiterlesenAusbauTierheim.php" class="button" draggable="false"><i class="fa-solid fa-newspaper"></i> Weiterlesen</a>
            </div>
            <div>
                ...
                <a href="aktuellesWeiterlesen.php" class="button" draggable="false"><i class="fa-solid fa-newspaper"></i> Weiterlesen</a>
            </div>
            <div>
    ...
    <div class="tile">
        ...
        <div class="box-container" id="copyAllAnimalsHere"></div>

        <div class="hidden" id="hiddenAnimal">
            <div class="aussenboxBildwechselKlein">
                <a class="bildwechsel" draggable="false">&nbsp;</a>
            </div>
            <h3></h3>
            <p class="beschreibungBeginn"></p>
        </div>
        
        <a href="unsereTiere" class="button marginTopButton" draggable="false"><i class="fa-solid fa-plus"></i> Weitere Tiere ansehen</a>
    </div>
</div>