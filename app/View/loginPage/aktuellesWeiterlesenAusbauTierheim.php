        ...
        <main>
            ...
            <div class="box-absolute">
                <div class="kopfelement">
                    <h3 class="inline">Ausbau Tierheimat</h3>
                ...
                <div class="unterelement bildWeiter">
                    <img src="../../../public/img/ausbauTierheim.jpg" class="hohesBild" alt="Lageplan Tierheim" title="Lageplan Tierheim" draggable="false" />

                    <img src="../../../public/img/ausbauTierheim.jpg" class="niedrigesBild" alt="Lageplan Tierheim" title="Lageplan Tierheim" draggable="false" />
                </div>
                <div class="unterelement scrollbar">
                    <p class="textTrennung">
                        Sehr geehrte Unterstützer und Freunde unseres Tierheims,
                    </p><br /><p>
                        wir freuen uns sehr, Ihnen mitteilen zu können, dass die bauliche Erweiterung unseres Tierheims erfolgreich begonenn hat.
                    </p><p>
