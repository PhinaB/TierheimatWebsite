        ...
        <main>
            ...
            <div class="box-absolute">
                ...
                <div class="unterelement bildWeiter">
                    <img src="../img/tierheimFest.jpg" class="hohesBild" alt="Bild eines Hundes mit dem Schriftzug 'Tierheimfest'" title="Bild eines Hundes mit dem Schriftzug 'Tierheimfest'" draggable="false" />

                    <img src="../img/tierheimFest.jpg" class="niedrigesBild" alt="Bild eines Hundes mit dem Schriftzug 'Tierheimfest'" title="Bild eines Hundes mit dem Schriftzug 'Tierheimfest'" draggable="false" />
                </div>
