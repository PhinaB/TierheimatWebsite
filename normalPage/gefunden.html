            ...
            <div id="menuRight">
                ...
                <div class="dropdown colorGreen">
                    ...
                    <div class="submenu bigWidthSubmenu">
                        ...
                        <a class="disabled">Gefundene Tiere</a>
                    </div>
                </div>
            ...
            <div class="tile druckenNichtDarstellen">
                ...
                <div class="box-containerVermisstGefundenMelden">
                    <div class="vermisstGefundenText zentriert">
                        ...
                        <br />
                        <a href="../normalPage/login.html" class="button" title="Button zum Login" draggable="false"><i class="fa-solid fa-right-to-bracket"></i>  Zum Login</a>
                    </div>
