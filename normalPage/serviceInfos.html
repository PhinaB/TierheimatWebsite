...
<body>
    ...
    <div class="grid">
        <main>
            ...
            <div class="tile">
                ...
                <div class="box-containerserviceInfo zentrierterButton">
                    <div>
                        <img src="../img/spaziereGehen.jpg" class="schattenBild" alt="Bild eines Hundes der im Wald spazieren geht" title="Bild eines Hundes der im Wald spazieren geht" draggable="false"/>
                    </div>
                    ...
                    <div>
                        ...
                        <br />
                        <a href="../normalPage/login.html" class="button" title="ButtonZum Login" draggable="false"><i class="fa-solid fa-right-to-bracket"></i>   Zum Login</a>
                    </div>
                </div>
            </div>
            <div class="tile">
        ...
        <footer>
            ...
            <div>
                <h4 id="Spendenkonto">UNSER SPENDENKONTO</h4>
                <p>
                    Tierheimat e.V.<br />
