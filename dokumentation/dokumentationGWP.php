    ...
    <main>
        <div class="container deckblatt">
            <div>
                ...
                <h1>Tierheimat</h1>
                <br /><br /><br />
                <img src="../imgDokumentation/logoFHE.jpg" alt="Logo FHE" title="Logo FHE" draggable="false">
                <br /><br /><br />
        ...
        <div class="container">
            <div class="section">
                ...
                <p>
                    ...
                    <img src="../img/logo.jpg" class="inlineLogo" alt="Tierheimat Logo" title="Tierheimat Logo" draggable="false">.
                </p><br />
                <p>
                ...
                <div class="section">
                    ...
                    <br />
                    <img src="../imgDokumentation/tierschutzLogo.png" title="Tierschutz" alt="Tierschutz Logo, ein Herz für Tiere" draggable="false">
            ...
            <div class="section">
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/tierheimErfurt-1.PNG" class="imgEffekt" title="Erfurt Tierheim" alt="Erfurt Tierheim aktuelles Seite" draggable="false">
                        <img src="../imgDokumentation/tierheimErfurt-2.PNG" class="imgEffekt" title="Erfurt Tierheim" alt="Erfurt Tierheim Interessantes Seite" draggable="false">
                    </div><div class="caption">Abbildung 2 und 3</div>
                    <br class="pageToSmall" />

                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/tierheimLeipzig.PNG" class="imgEffekt" title="Tierheim Leipzig" alt="Tierheim Leipzig Startseite" draggable="false">
                        <img src="../imgDokumentation/tierheimLeipzig-1.PNG" class="imgEffekt" title="Tierheim Leipzig" alt="Tierheim Leipzig Detaillansicht eines Tieres" draggable="false">
                    </div><div class="caption">Abbildung 4 und 5</div>
                    <br class="pageToSmall" />

                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/tierheimJena.PNG" class="imgEffekt" title="Tierheim Jena" alt="Tierheim Jena Startseite" draggable="false">
                        <img src="../imgDokumentation/tierheimJena-1.PNG" class="imgEffekt" title="Tierheim Jena" alt="Tierheim Jena unsere Tiere" draggable="false">
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/zielgruppenanalyse.jpg" title="Zielgruppenanalyse" alt="Tabelle der Zielgruppenanalyse" draggable="false">
                    </div>
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/projektanforderung-1.PNG" class="imgEffekt" title="Projektanforderung Vorlesung" alt="Projektanforderung Vorlesung Prof. Kruse" draggable="false">
                        <img src="../imgDokumentation/projektanforderung-2.PNG" class="imgEffekt" title="Projektanforderung Vorlesung" alt="Projektanforderung Vorlesung Prof. Kruse" draggable="false">
                        <img src="../imgDokumentation/projektanforderung-3.PNG" class="imgEffekt" title="Projektanforderung Vorlesung" alt="Projektanforderung Vorlesung Prof. Kruse" draggable="false">
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/arbeitsplanDokumentation.PNG" title="Arbeitsplanung Phase 1-4" alt="Arbeitsplanung Phase 1-4" draggable="false">
                    </div>
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/jiraAufteilung.PNG" title="Jira Auszug Projekt: Tierheimat" alt="Jira Auszug Projekt: Tierheimat" draggable="false">
        ...
        <div class="container">
            <div class="section">
                ...
                <div class="section">
                    ...
                    <img src="../imgDokumentation/webseitenstruktur.jpg" title="Webseitenstruktur" alt="Webseitenstruktur" draggable="false">
                ...
                <div class="section">
                    ...
                    <div class="alternative">
                        <img src="../img/logo.jpg" title="Tierheimat Logo" alt="Tierheimat Logo" draggable="false">
                    </div>
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/figmaModel-2.2.PNG" class="imgEffekt" title="Figma 2.2" alt="Figma Model 2.2" draggable="false">
                        <img src="../imgDokumentation/figmaModel-2.4.PNG" class="imgEffekt" title="Figma 2.4" alt="Figma Model 2.4" draggable="false">
                    </div>
                    <br class="pageToSmall" />
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/figmaModel-3.5.PNG" class="imgEffekt" title="Figma 3.5" alt="Figma Model 3.5" draggable="false">
                        <img src="../imgDokumentation/figmaModel-3.7.PNG" class="imgEffekt" title="Figma 3.7" alt="Figma Model 3.7" draggable="false">
                    </div>
                    ...
                    <br />
                    <img src="../imgDokumentation/logoMitte.jpg" title="Bild der ersten Entüwrfe, Logo mittig" alt="Logo mittig" draggable="false">
                    <img src="../imgDokumentation/logoLinks.jpg" title="Bild der ersten Entüwrfe, Logo links" alt="Logo links" draggable="false">
                    <img src="../imgDokumentation/logoOben.jpg" title="Bild der ersten Entüwrfe, Logo oben" alt="Logo oben" draggable="false">
                    <img src="../imgDokumentation/logoObenLinksFarbig.jpg" title="Bild der ersten Entüwrfe, Logo oben links farbig" alt="Logo oben linksbündig" draggable="false">
                    <img src="../imgDokumentation/logoObenMitte.jpg" title="Bild der ersten Entüwrfe, Logo oben mittig" alt="Logo oben mittig und farbig" draggable="false">
                    <img src="../imgDokumentation/logoObenMitteFarbig.jpg" title="Bild der ersten Entüwrfe, Logo oben mittig mit Farbe" alt="Logo oben mittig mit Farbe" draggable="false">
                    ...
                    <br />
                    <img src="../imgDokumentation/logoFinal.PNG" title="Finales Logo" alt="Finales Logo im Design und Bsp." draggable="false">
        ...
        <div class="container">
            <div class="section">
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/formUnsereTiere.jpg" class="imgEffekt" title="Screenshot der Filterung für die Seite 'Unsere Tiere'" alt="Screenshot der Filterung für die Seite 'Unsere Tiere'" draggable="false">
                        <img src="../imgDokumentation/formKleinVermisstGefunden.jpg" class="imgEffekt" title="Screenshot der Filterung für die Seite 'Vermisst / Gefunden'" alt="Screenshot der Filterung für die Seite 'Vermisst / Gefunden'" draggable="false">
                        <img src="../imgDokumentation/unsereTiereWeitereTiere.jpg" class="imgEffekt" title="Screenshot Button für die Seite 'Unsere Tiere', um weitere Tiere anzuzeigen" alt="Screenshot Button für die Seite 'Unsere Tiere', um weitere Tiere anzuzeigen" draggable="false">
                    </div>
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/formLoginRegistration.jpg" class="imgEffekt" title="Screenshot Formulare Login und Registration" alt="Screenshot Formulare Login und Registration" draggable="false">
                    </div>
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/formVermisstGefunden.jpg" class="imgEffekt" title="Screenshot Formular vermisste und gefundene Tiere melden" alt="Screenshot Formular vermisste und gefundene Tiere melden" draggable="false">
                        <img src="../imgDokumentation/formHelfen.jpg" class="imgEffekt" title="Screenshot Formular Helfen" alt="Screenshot Formular Helfen" draggable="false">
                    </div>
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/beispielLoeschenBearbeiten.jpg" class="imgEffekt" title="Screenshot Löschen und Bearbeiten Buttons" alt="Screenshot Löschen und Bearbeiten Buttons" draggable="false">
                    </div>
                    ...
                    <img src="../imgDokumentation/richtigerCodestyle.PNG" title="richtiger Codestyle" alt="Bild von einem verbesserten Codestyle" draggable="false">
        ...
        <div class="container">
            <div class="section">
                ...
                <div class="Dokumentation">
                    <img src="../imgDokumentation/processDocumentation.jpg" title="Process Documentation" alt="Ablauf der Process Documentation" draggable="false">
        ...
        <div class="container">
            <div class="section">
                ...
                <div class="section">
                    ...
                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/ordnerStruktur.PNG" title="ordnerStruktur" alt="Bild der Ordnerstruktur" draggable="false">
                    </div>
                    <div class="caption">Abbildung 31</div>

                    <div class="divAroundImgEffekt">
                        <img src="../imgDokumentation/ordnerstrukturierung.PNG" title="ordnerstrukturierung" alt="gute Ordnerführung" draggable="false">
                    </div>
        ...
        <div class="container">
            ...
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/tierheimErfurt-3.PNG" title="Erfurt Tierheim" alt="Erfurt Tierheim detaillierte Ansicht des Tieres" draggable="false">
            </div><div class="caption">Abbildung 33</div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/tierheimErfurt-4.PNG" title="Erfurt Tierheim" alt="Erfurt Tierheim Foto Galerie" draggable="false">
            </div><div class="caption">Abbildung 34</div>
            <br />

            <h3>Tierheim Leipzig:</h3>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/tierheimLeipzig-2.PNG" title="Tierheim Leipzig" alt="Leipzig Tierheim Tier entlaufen und gefunden" draggable="false">
            </div><div class="caption">Abbildung 35</div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/tierheimLeipzig-3.PNG" title="Tierheim Leipzig" alt="Leipzig Tierheim vermittlungsbedingungen" draggable="false">
            </div><div class="caption">Abbildung 36</div>

            <h3>Tierheim Jena:</h3>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/tierheimJena-2.PNG" title="Tierheim Jena" alt="Tierheim Jena Kontaktformular" draggable="false">
            </div><div class="caption">Abbildung 37</div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/tierheimJena-3.PNG" title="Tierheim Jena" alt="Tierheim Jena Aktuelle Nachrichten" draggable="false">
            ...
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-1.PNG" title="Figma Model 1" alt="Figma Model 1" draggable="false">
            </div>
            ...
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-2.1.PNG" title="Figma Model 2" alt="Figma Model 2.1" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-2.2.PNG" title="Figma Model 2" alt="Figma Model 2.2" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-2.3.PNG" title="Figma Model 2" alt="Figma Model 2.3" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-2.4.PNG" title="Figma Model 2" alt="Figma Model 2.4" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-2.5.PNG" title="Figma Model 2" alt="Figma Model 2.5" draggable="false">
            </div>
            ...
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.1.PNG" title="Figma Model 3" alt="Figma Model 3.1" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.2.PNG" title="Figma Model 3" alt="Figma Model 3.2" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.3.PNG" title="Figma Model 3" alt="Figma Model 3.3" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.4.PNG" title="Figma Model 3" alt="Figma Model 3.4" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.5.PNG" title="Figma Model 3" alt="Figma Model 3.5" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.6.PNG" title="Figma Model 3" alt="Figma Model 3.6" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.7.PNG" title="Figma Model 3" alt="Figma Model 3.7" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.8.PNG" title="Figma Model 3" alt="Figma Model 3.8" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.9.PNG" title="Figma Model 3" alt="Figma Model 3.9" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.10.PNG" title="Figma Model 3" alt="Figma Model 3.10" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.11.PNG" title="Figma Model 3" alt="Figma Model 3.11" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.12.PNG" title="Figma Model 3" alt="Figma Model 3.12" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.13.PNG" title="Figma Model 3" alt="Figma Model 3.13" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.14.PNG" title="Figma Model 3" alt="Figma Model 3.14" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.15.PNG" title="Figma Model 3" alt="Figma Model 3.15" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-3.16.PNG" title="Figma Model 3" alt="Figma Model 3.16" draggable="false">
            </div>
            ...
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-4.1.PNG" title="Figma Model 4" alt="Figma Model 4.1" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-4.2.PNG" title="Figma Model 4" alt="Figma Model 4.2" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-4.3.PNG" title="Figma Model 4" alt="Figma Model 4.3" draggable="false">
            </div>
            ...
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-5.1.PNG" class="imgEffekt" title="Figma Model 5" alt="Figma Model 5.1" draggable="false">
                <img src="../imgDokumentation/figmaModel-5.6.PNG" class="imgEffekt" title="Figma Model 5" alt="Figma Model 5.6" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-5.3.PNG" class="imgEffekt" title="Figma Model 5" alt="Figma Model 5.3" draggable="false">
                <img src="../imgDokumentation/figmaModel-5.4.PNG" class="imgEffekt" title="Figma Model 5" alt="Figma Model 5.4" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-5.5.PNG" class="imgEffekt" title="Figma Model 5" alt="Figma Model 5.5" draggable="false">
                <img src="../imgDokumentation/figmaModel-5.2.PNG" class="imgEffekt" title="Figma Model 5" alt="Figma Model 5.2" draggable="false">
            </div>
            <div class="divAroundImgEffekt">
                <img src="../imgDokumentation/figmaModel-5.8.PNG" class="imgEffekt" title="Figma Model 5" alt="Figma Model 5.8" draggable="false">
            </div>
